...
Route::middleware(['auth', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::get('/rental/data', [RentalController::class, 'getData'])->name('admin.rental.data');
...
Route::middleware(['auth', 'role:user'])->prefix('user')->group(function () {
    ...
    Route::get('/rent/history', [RentalUserController::class, 'history'])->name('user.rentals.history');
    Route::post('/rent/return-request/{id}', [RentalUserController::class, 'requestReturn'])->name('user.rentals.requestReturn');
    Route::get('/rentals/pay-penalty/{penalty}', [RentalUserController::class, 'showPenaltyPayment'])->name('user.rentals.payPenalty');
    Route::post('/rentals/midtrans-callback', [RentalUserController::class, 'midtransCallback'])->name('user.rentals.midtransCallback');
});
